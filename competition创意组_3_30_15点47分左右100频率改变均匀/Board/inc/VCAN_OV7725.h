...
#define CAMEAR_PIC_SIZE     (OV7725_EAGLE_W*OV7725_EAGLE_H)
...
#define CAMERA_Fit_SIZE            (CAMERA_Fit_H*CAMERA_Fit_W)
...
extern YesNo_t imgDealOk;
extern uint8 imgbuff[CAMERA_SIZE];
extern uint8 a_In_imgbuff[OV7725_EAGLE_H][OV7725_EAGLE_W];                              //定义存储接收图像的数组
